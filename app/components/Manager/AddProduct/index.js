        ...
        <Row>
          ...
          <Col xs='12' md='12' className='my-2'>
            <Switch
              ...
              checked={productFormData.stockAvailable}
              toggleCheckboxChange={value => productChange('stockAvailable', value)}
            />
          </Col>
          <Col xs='12' md='12' className='my-2'>
            <Switch
              ...
              toggleCheckboxChange={value => productChange('isAvailable', value)}
            />
          </Col>
        </Row>
        <hr />
